...
/**
 * http://jin8000608172.iteye.com/blog/2120385
 * 
 * @author jqmtony [H]
 *
 */
public class BaseResult implements Serializable {
	...
	/**
	 * 消息本地化可看 章节“消息本地化”
	 * http://wiki.inzwc.com/wiki/index.php/xxxAppModel#.E6.B6.88.E6.81.AF.E6.9C.AC.E5.9C.B0.E5.8C.96
	 * 
	 * @return
	 */
	...
	public <SubClass extends BaseResult> SubClass withErrorAndLog(String inputParamWhereCatch, Throwable e) {
		return withErrorAndLog(
				...
				""/*
					 * UnknownErrorCodeConstant.getMsg(UnknownErrorCodeConstant.
					 * exceptionCanRetry)
					 */, inputParamWhereCatch, e);
	}

	public <SubClass extends BaseResult> SubClass withErrorAndLog(String errorCode, String inputParamWhereCatch,
			Throwable e) {
		return withErrorAndLog(errorCode,
				""/* UnknownErrorCodeConstant.getMsg(errorCode) */, inputParamWhereCatch, e);
	}
	 ...
	 */
	public <SubClass extends BaseResult> SubClass withError(int errorCode, String errorMsg,
			String inputParamWhereCatch) {
